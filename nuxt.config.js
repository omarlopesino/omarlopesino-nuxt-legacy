  ...
  */
  head: {
    ...
    link: [
      ...
      { rel: 'preload', href: 'https://fonts.googleapis.com/css?family=Inconsolata|Roboto+Mono|Source+Code+Pro:400,700,Ubuntu+Mono', as: 'style', onload: "this.rel='stylesheet'"},
    ]
  },
  /*
